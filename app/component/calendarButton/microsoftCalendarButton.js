...
export default class MicrosoftCalendarButton extends Component
{
  constructor(props)
  {
    super(props);
    ...
    return (
      <View style={styles.container}>
        ...
        <MyButton
          ...
          title={AppText.calendarButton.microsoftCalendarButton.text}
...
module.exports = MicrosoftCalendarButton;
