...
export default class SelectPicker extends PureComponent {
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        const items = SelectPicker.handlePlaceholder({
            placeholder: nextProps.placeholder,
        }).concat(nextProps.items);
        const itemsChanged = !isEqual(prevState.items, items);

        // update selectedItem if value prop is defined and differs from currently selected item
        const { selectedItem, idx } = SelectPicker.getSelectedItem({
            items,
    ...
    constructor(props) {
        ...
        const { selectedItem } = SelectPicker.getSelectedItem({
            items,
            key: props.itemKey,
            value: props.value,
        });
    ...
    {
      //console.log('Select picker value: ' + value);
    ...
    renderIcon() {
        ...
        return (
            <View
                ...
                style={[defaultStyles.iconContainer, this.props.style.iconContainer]}
            >
                <this.props.icon testID="icon" />
            </View>
        );
    }

    renderTextInputOrChildren() {
        const { children, textInputProps } = this.props;
        const { selectedItem } = this.state;

        const containerStyle =
            Platform.OS === 'ios' ? this.props.style.inputIOSContainer : this.props.style.inputAndroidContainer;
        ...
        return (
            <View pointerEvents="box-only" style={containerStyle}>
                <TextInput
                  testID="text_input"
                  style={[
                      Platform.OS === 'ios' ? this.props.style.inputIOS : this.props.style.inputAndroid,
