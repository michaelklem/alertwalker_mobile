...
const MyAgainstCell = ({ data }) =>
{
  ...
  {
    winnerStyle = data.ownerStance === "against" ? Styles.forName : Styles.againstName;
    winnerText = data.ownerStance === "against" ? data[data.positionKey].name : otherUser.name;
  }
  else if(data.winner === "opponent")
  {
    winnerStyle = data.ownerStance === "against" ? Styles.againstName : Styles.forName;
    winnerText = data.ownerStance === "against" ? otherUser.name : data[data.positionKey].name;
  }
  ...
  return(
    <View style={Styles.detailRowHolder}>
      ...
      <View style={[Styles.column]}>
        ...
        <View style={Styles.discussionCellAgainstBar} />
...
const styles = StyleSheet.create({
  bottomImage: {
    ...
    width: '100%',
    height: '100%',
    paddingRight: 5, // To account for against bar
    top: 0,
    left: 0,
  },
  nameRow: {
