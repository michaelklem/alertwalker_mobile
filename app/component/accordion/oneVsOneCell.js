...
const OneVsOneCell = ({ data }) =>
{
  ...
  const forUser = data.ownerStance === 'for' ? data.owner : data.opponent;
  const againstUser = data.ownerStance === 'against' ? data.owner : data.opponent;
  ...
  if(data.winner === "owner")
  {
    ...
    winnerText = data.ownerStance === "for" ? forUser.name : againstUser.name;
  }
  else if(data.winner === "opponent")
  {
    winnerStyle = data.ownerStance === "for" ? Styles.againstName : Styles.forName;
    winnerText = data.ownerStance === "for" ? againstUser.name : forUser.name;
  }
