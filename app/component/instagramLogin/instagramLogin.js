...
export default class Instagram extends Component
{
  ...
  async onNavigationStateChange(webViewState)
  {
    ...
    if (url && url.startsWith(this.props.redirectUrl)) {
      ...
      this.props.updateMasterState({ instagramModalVisible: false });
      if(this.props.updateFormInput)
      {
        this.props.updateFormInput();
      }
  ...
  renderClose() {
    ...
    return (
      <Image
        source={Images.instagramCloseBtn}
  ...
  render() {
    //console.log("InstagramLogin.render()\n" + this.props.modalVisible);
