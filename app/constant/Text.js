...
{
  submit: 'Submit',
  cHeaderTextVillageL2: 'The Village',
  cHeaderTextParentFeedL2: 'Parent Feed',

  cHeaderChatText: 'Chat',
  cHeaderCreateNewText: 'Create new debate',
  cHeaderCreateText: 'New debate',
  cHeaderDetailText: '1v1 debate arena',
  cHeaderSettingsText: 'Settings',
  cHeaderLoginRequiredText: 'Please login first',

  cGroupMessageTextFieldPlaceHolderText: 'Message...',

  homeSearchPlaceholderText: ' Search groups/keywords',

  rememberMeBtn: 'Remember me',
  formHelperText: 'Please enter a valid ',

  pCreateSubjectText: 'Subject',
  pCreateBodyText: 'Make a statement and unleash hell',
  pCreateHashtagsText: '#your hashtags',
  pCreateDebateTitle: 'The debate title',
  pCreateForText: 'For',
  pCreateAgainstText: 'Against',
  pCreateChooseStanceText: 'Choose your stance',
  pCreateChooseTypeText: 'Choose the type of debate',
  pCreateOneVsOneText: '1 vs 1',
  pCreateOpenText: 'Open',
  pCreateLinkText: 'Choose a link',
  pCreatePublicText: 'Public',
  pCreatePrivateText: 'Private',
  pCreateSendText: 'Send to user',
  pCreateSelectUserText: 'Select users to invite',
  pCreateCloseUserModal: 'Close',
  pCreateUserModalActionText: 'Send',
  pCreatePublishText: 'Publish',
  pCreateSendSuccessText: 'Users will be notified once you click publish/save',

  pDetailVsText: 'vs',
  pDetailBrutalText: 'Brutal',
  pDetailFunniestText: 'Funniest',
  pDetailAgainstText: 'Against',
  pDetailForText: 'For',
  pDetailCommentPlaceholderText: 'Comment ...',
  pDetailYourStanceText: 'Your stance',
  pDetailChallengeText: 'Challenge',
  pDetailWonText: 'WON',
  pDetailWaitingForResponseText: 'Waiting for response',
  pDetailAcceptText: 'Accept',
  pDetailDeclineText: 'Decline',

  cHeaderConversationsText: 'Conversations',

  pConfirmResetHeaderText: 'Finish resetting your password',

  homePage:
  {
    noWidgets:
    {
      text: 'No social media accounts linked yet? Use the quick add feature on the top right to add one!'
    }
  },
  subscriptionPayModal:
  {
    ...
    header:
    {
      text: 'PURCHASE CUSTOMIZATION'
    },
    body:
    {
      text: 'To be able to access the additional features Aspire has to offer, please purchase a subscription with Apple\'s in-app purchase'
    },
    whatYouGet:
    {
      text: 'Aspire Premium Monthly\n\nYou will get access to the Budget planner, Meal planner, Fitness planner, Grocery list, and PDF editor\n\nThis is an auto-renewable subscription that will be billed monthly\n'
    }
  },
  searchPage:
  {
  ...
  groups:
  {
    onlyGroupsUserIsIn: 'Only displaying groups you are in ',
    notOnlyGroupsUserIsIn: 'Showing all groups ',
    filterLabel: 'Show groups you are in ',
  ...
  loginContainer:
  {
    chooseLabel:
    {
      text: 'Choose one of the following logins'
    }
  },
  ...
  welcomePage:
  {
    beta:
    {
      text: 'Aspire is in beta mode at the moment, enter your invite code to gain access'
    }
  },
  ...
  confirmResetPage:
  {
    layout2:
    {
      instructionText: 'Set your new password for your account'
    }
  },
  ...
  additionalPage:
  {
    layout1:
    {
      layoverMenuTitle: 'Additional Features'
    }
  },
  calendarPage:
  {
    layout1:
    {
      ...
      layoverMenuTitleText: 'Choose Note',
      save: 'Save',
    }
  },
  budgetPage:
  {
    ...
    incomeText: 'Budget Income',
    totalIncomeText: 'Total Income',
    fixedExpensesText: 'Fixed Expenses',
    totalFixedExpensesText: 'Total Fixed Expenses',
    variableExpensesText: 'Variable Expenses',
    totalVariableExpensesText: 'Total Variable Expenses',
    deptSavingsText: 'Dept / Savings',
    totalDeptSavingsText: 'Total Dept / Savings',
    budgetedText: 'Budgeted',
    budgetText: 'Budget',
    actualText: 'Actual',
    fixedText: 'Fixed Expenses'
  },
  fitnessPage:
  {
    titleText: 'Fitness',
    date: 'Date',
    workout: 'Workout: Results and comments',
    time: 'Time',
    notes: 'Notes',
    cumulativeDistance: 'Cumulative Distance',
    noLogs: 'No logs yet, create one?',
  },
  groceryPage:
  {
    titleText: 'Grocery',
  ...
  emailPage:
  {
    layoverMenuTitle:
    {
      text: 'Must be logged in the email app on your device'
    }
  },
  notesPage:
  {
    ...
    {
      filterText: 'notes by  ',
      layoverMenuTitle: 'Entries by  ',
      noNotes: 'No notes yet, create one?',
      templateCategory: 'Create Template',
  ...
  phonePage:
  {
    layout1:
    {
      ...
      noChats:
      {
        text: 'No contacts yet, did you allow permission?'
      },
      noCalls:
      {
        text: 'No calls yet, start one?'
      },
      search:
      {
        text: ' Search'
  ...
  resetPage:
  {
    layout2:
    {
      instructionText: 'Instructions for resetting the password will be sent to your email'
    }
  },
  ...
  settingsPage:
  {
    layout4:
    {
      ...
      upgradeText: 'Upgrade Account',
      backText: 'Back',
      isUpgraded:
      {
        text: 'Account Upgraded Already'
      }
    }
  },
  ...
  pLoginWelcomeText: 'Welcome Back,',
  pLoginSubWelcomeText: 'Sign in to continue',
  pLoginForgotPasswordBtnText: 'Forgot password?',
  pLoginRegisterLblText: 'Don\'t have an account yet? ',
  pLoginRegisterBtnText: 'Sign Up',
  pLoginSkipText: 'Register later',
  pLoginQuote: 'Parenting is tough but together it doesn’t have to be',

  pRegisterSubmitBtnText: 'REGISTER',
  pRegisterSubWelcomeText: 'Create your account to continue',
  pRegisterWelcomeText: 'Welcome to Offspring',
  pRegisterLoginLblText: 'Already have an account ?',
  pRegisterLoginBtnText: 'Login',

  pResetBackText: 'Back',
  pResetSubWelcomeText: 'Enter the email address associated with your account',

  pHomeDetailJoinDebateText: 'Join the debate by',

  pSettingsPasswordNoteText: 'Leave password fields blank if not changing password',
  pSettingsWinText: 'Win',
  pSettingsLoseText: 'Lose',
  pSettingsOneVOneText: '1 V 1',
  pSettingsDebatesText: 'debates',
  pSettingsLogoutText: 'Logout',
