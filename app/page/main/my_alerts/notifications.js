...
export default class Notifications extends Component
{
  ...
  constructor(props)
  {
    ...
    this._token =  AsyncStorage.getItem('token');
    this.state =
    {
      isLoading: false,
      notifications:  this._notificationMgr.getMyNotifications(this._token)
    };
    ...
    this._unsubscribe = props.navigation.addListener('focus', async() =>
    {
      ...
      else
      {
        ...
        this.setState({ isLoading: false, notifications: await this._notificationMgr.getMyNotifications(token) });
      }
    });
  ...
  dataReloaded = async () =>
  {
    this.setState({ notifications: await this._notificationMgr.getMyNotifications(this._token) });
  }
